- [1. Day01](#1-day01)
  - [1.1. HTML 语法规范](#11-html-语法规范)
    - [1.1.1. 源码](#111-源码)
  - [1.2. 第一个页面](#12-第一个页面)
    - [1.2.1. 源码](#121-源码)
    - [1.2.2. 页面渲染图](#122-页面渲染图)
  - [1.3. VSCODE创建页面](#13-vscode创建页面)
    - [1.3.1. 源码](#131-源码)
    - [1.3.2. 页面渲染图](#132-页面渲染图)
  - [1.4. 标题标签](#14-标题标签)
    - [1.4.1. 源码](#141-源码)
    - [1.4.2. 页面渲染图](#142-页面渲染图)
  - [1.5. 段落和换行标签](#15-段落和换行标签)
    - [1.5.1. 源码](#151-源码)
    - [1.5.2. 页面渲染图](#152-页面渲染图)
  - [1.6. 体育新闻](#16-体育新闻)
    - [1.6.1. 源码](#161-源码)
    - [1.6.2. 页面渲染图](#162-页面渲染图)
  - [1.7. 文本格式化标签](#17-文本格式化标签)
    - [1.7.1. 源码](#171-源码)
    - [1.7.2. 页面渲染图](#172-页面渲染图)
  - [1.8. div和span标签](#18-div和span标签)
    - [1.8.1. 源码](#181-源码)
    - [1.8.2. 页面渲染图](#182-页面渲染图)
  - [1.9. 图像标签](#19-图像标签)
    - [1.9.1. 源码](#191-源码)
    - [1.9.2. 页面渲染图](#192-页面渲染图)
  - [1.10. demo](#110-demo)
  - [1.11. 同一级路径](#111-同一级路径)
    - [1.11.1. 源码](#1111-源码)
    - [1.11.2. 页面渲染图](#1112-页面渲染图)
  - [1.12. 下一级路径](#112-下一级路径)
    - [1.12.1. 源码](#1121-源码)
    - [1.12.2. 页面渲染图](#1122-页面渲染图)
  - [1.13. 绝对路径](#113-绝对路径)
    - [1.13.1. 源码](#1131-源码)
    - [1.13.2. 页面渲染图](#1132-页面渲染图)
  - [1.14. 超链接标签](#114-超链接标签)
    - [1.14.1. 源码](#1141-源码)
    - [1.14.2. 页面渲染图](#1142-页面渲染图)
  - [1.15. 锚点定位](#115-锚点定位)
    - [1.15.1. 源码](#1151-源码)
    - [1.15.2. 页面渲染图](#1152-页面渲染图)
  - [1.16. 注释标签和特殊字符](#116-注释标签和特殊字符)
    - [1.16.1. 源码](#1161-源码)
    - [1.16.2. 页面渲染图](#1162-页面渲染图)
...
![1678794468552](image/1678794468552.png)
...
![1678794507127](image/1678794507127.png)
...
![1678794610052](image/1678794610052.png)
...
![1678794639720](image/1678794639720.png)
...
![1678794672969](image/1678794672969.png)
![1678794683875](image/1678794683875.png)
...
![1678794766433](image/1678794766433.png)
...
![1678794782907](image/1678794782907.png)
...
![1678794812509](image/1678794812509.png)
...
![1678794829198](image/1678794829198.png)
